...
class SMS:
    ...
    def main(phone_number, code2):
        ...
        send_sms_request = dysmsapi_20170525_models.SendSmsRequest(
            sign_name='Vectorizer',
            template_code='SMS_307081209', #SMS_475295449
    ...
    async def main_async(
        ...
        client = SMS.create_client()
        send_sms_request = dysmsapi_20170525_models.SendSmsRequest(
            sign_name='Vectorizer矢量',
            template_code='SMS_475295449', #SMS_475295449
            phone_numbers='{}'.format(phone_number),
            emplate_param='{"code":"'+str(code2)+'"}',
        )
        runtime = util_models.RuntimeOptions()
        try:
            # 复制代码运行请自行打印 API 的返回值
